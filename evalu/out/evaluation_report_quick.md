...
*Sinh tự động lúc 2026-08-07T03:43:28+00:00 — `python evalu/run_evaluation.py`*
...
| M4.2 | Zero-Report Self-Praise Exclusion | 0.00% | 0 / 1 | FAIL |
...
Giá trị: **0.00%** (0/1) · Mục tiêu: 100%

Phân loại vi phạm: `has_conduct_edge` = 1
