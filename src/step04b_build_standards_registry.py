...
Re-running preserves human edits (merge_preserving_edits, reused from step04); --force rebuilds.

  python src/step04b_build_standards_registry.py                 # draft, then hand-confirm
  python src/step04b_build_standards_registry.py --force         # discard edits, rebuild
"""
...
from step04_build_issuer_registry import merge_preserving_edits, normalize_name
