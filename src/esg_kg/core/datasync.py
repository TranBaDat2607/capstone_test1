...
Run from the repo root:
    python src/esg_kg/core/datasync.py push --repo-id <user_or_org>/<name>   # maintainer, after a rebuild
    python src/esg_kg/core/datasync.py pull                                  # teammate, reads data_version.json
