...
canonical graph):
    ...
    python src/step03b_anchor_kpi_facilities.py --dry-run   # preview matches
    python src/step03b_anchor_kpi_facilities.py             # append to validated triples
"""
...
from step03_fix_invalid_triplets import load_schema_sets, validate_triple
