...
every Phase-0 fix has a measured before/after snapshot:
    ...
    python src_module/run.py quality --label baseline
    ... apply changes, rebuild graph ...
    python src_module/run.py quality --label after-p1

(`python -m esg_kg.report.quality --label baseline`, run from `src_module/`, is
