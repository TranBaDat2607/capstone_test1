...
Run from the REPO ROOT:
    ...
    python src_module/run.py fix_triples --dry-run     # phase 1 only, no LLM, no writes
    python src_module/run.py fix_triples               # full run
    python src_module/run.py fix_triples --renormalize # P4 pass over the existing file
