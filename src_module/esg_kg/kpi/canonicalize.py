...
Run from the repo root, after step03b (anchor_kpi) and before the registries/step05:
  python src_module/run.py canonicalize --dry-run
  python src_module/run.py canonicalize
Equivalently, from inside src_module/:  python -m esg_kg.kpi.canonicalize --dry-run
